  ...
  return (
    <React.Fragment>
        ...
        <AboutStyled className="about">
          <div className="about--content">
            <p className="about--one">
              ...
              <span>{props.language.iconAbout}</span>
            </p>
          </div>
      ...
      <ContactStyled className="contact">
        <p>
          {props.language.contactLinkedin}{" "}
          <a
            href="https://www.linkedin.com/in/k%C3%A9vin-joya-5b6250133/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Linkedin
          </a>{" "}
          {props.language.contactGithub}{" "}
          <a
            href="https://github.com/Kvin3324"
            target="_blank"
            rel="noopener noreferrer"
          >
            Github
